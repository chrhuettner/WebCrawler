...
class HeadingTest {
    ...
    @BeforeEach
    void setUp() {
        heading = new Heading(TYPE, TEXT, TARGET_LANGUAGE_CODE_GERMAN, Translator.getTranslator());
    }
    ...
    void testGetRepresentationNoText() {
        heading = new Heading(TYPE, "", TARGET_LANGUAGE_CODE_GERMAN, Translator.getTranslator());
